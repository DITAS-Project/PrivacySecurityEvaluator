...
sudo docker run -p 50008:8080 -e DOCKER_HOST_IP=$HOST_IP --restart unless-stopped -d --name privacy-security-evaluator ditas/privacy-security-evaluator:production
ENDSSH
