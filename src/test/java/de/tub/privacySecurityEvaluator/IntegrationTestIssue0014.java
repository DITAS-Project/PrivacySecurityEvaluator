...
@SpringBootTest
public class IntegrationTestIssue0014 {
    ...
    public static void checkIfFilesPresent() {
        Assert.assertNotNull(ApplicationTests.class.getResourceAsStream("/integration/issue14.json"));
    }
    ...
    public void test() {
        try {
            ...
            Request request = mapper.readValue(testHelper.readToString("/integration/issue14.json"), Request.class);
