...
@SpringBootTest
public class IntegrationTestIssue0031 {
    ...
    public static void checkIfFilesPresent() {
        Assert.assertNotNull(ApplicationTests.class.getResourceAsStream("/integration/issue31.json"));
    ...
    public void test() throws Exception{
        String request= helper.readToString("/integration/issue31.json");
